  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>AMK</b>POS</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Inventory|</b>AMK</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./category.php"><i class="fa fa-list-alt"></i> <span>ရွှေအရည်အသွေးပြင်မည်</span></a></li>
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>အသုံးပြုသူ</span></a></li>
          <li><a href="./product.php"><i class="fa fa-archive"></i> <span>ပစ္စည်းစာရင်း</span></a></li>
          <li><a href="./sellinglists.php"><i class="fa fa-newspaper-o"></i> <span>အရောင်းစာရင်း</span></a></li>
          <li><a href="./otherproduct.php"><i class="fa fa-balance-scale"></i> <span>Shwe Daung Yin</span></a></li>
